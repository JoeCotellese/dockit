...
def load_config():
    ...
    if not os.path.exists(config_file):
        print(f"Config file not found at {config_file}. Please create it with the required settings.")
        sys.exit(1)
    ...
    try:
        ...
        print("Config file must contain a [global] section with a 'base_directory' entry.")
        sys.exit(1)
